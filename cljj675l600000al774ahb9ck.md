...
* * i. Log in to your [Spheron account](https://spheron.network) and **"Start with Compute"** to deploy your Rust app.
...
ii. Then click on **"New Cluster"** to create a new cluster.
...
</div>![](https://cdn.hashnode.com/res/hashnode/image/upload/v1688163931240/8da91617-20d5-4bed-bf4d-39a0405bff75.png align="center")

iii. Select the **"Import from Docker Registry"** option, and fill in the *Name, Image and Tag fields.*
...
1. 1. iv. Select instance plan: Choose the appropriate plan for your Rust app.
...
7. v. Click Deploy: Initiate the deployment process.
